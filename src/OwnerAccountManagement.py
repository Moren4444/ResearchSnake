...
import flet as ft
from database import admin_profile_info, delete_user


def admin_account_management(page: ft.Page):
        ...
        return [
            ft.DataRow(
                cells=[
                    ...
                    ft.DataCell(ft.Text(user[4] if password_visible else "******", color="white")),  # Password
    ...
    add_user_button = ft.ElevatedButton("Add New Admin", on_click=lambda e: page.go("/add_new_admin"))
