...
font = pygame.font.Font("assets/PeaberryBase.ttf", 60)
small_font = pygame.font.Font("assets/PeaberryBase.ttf", 40)
smaller_font = pygame.font.Font("assets/PeaberryBase.ttf", 30)
...
def arrow(color="blue", push=""):
    if push == "":
        arrows = pygame.image.load(f"assets/MV_Icons_Letter_Buttons/Buttons/{color}-!arrowleft{push}.png")
    else:
        arrows = pygame.image.load(f"assets/MV_Icons_Letter_Buttons/Buttons/{color}-!arrowleft-{push}.png")
    arrows = pygame.transform.scale(arrows, (32 * 2, 32 * 2))
    arrow_rect = arrows.get_rect(topleft=(50, 30))
    return [arrows, arrow_rect]
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.MOUSEBUTTONDOWN:
            ...
            if Start_Button.collidepoint(event.pos):
                print("Start")
                pygame.quit()
                os.environ["DIFFICULTIES"] = str(selected[1])
