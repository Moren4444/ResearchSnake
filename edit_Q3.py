...
def main(page: ft.Page):
    try:
            ...
            for i in chapter_quizzes[selected_chapter_index]:
                if int(i[0]) == selected_index + 1:
                    if current_question not in check:
                        ...
                        update_title = (
                            old_title[0], quiz_name.value, description.value, old_title[3], old_title[4], old_title[5])
        ...
        def add_chapter(e):
            ...
            chapter_dd.update()
            print("QUiz ID: ", chapter_quizzes[len(chapter_quizzes)][0][0])
            Add_Question(chapter_quizzes[len(chapter_quizzes)][0][0])
        ...
        def confirm_delete_chapter(e):
            ...
            for i in chapter_quizzes[len(chapter_quizzes)]:
                list_quiz_chapter.append(int(i[0]))
            ...
            if chapter_dd.value == f"Chapter {len(chapter_quizzes) + 1}":
                ...
                update_column(int(chapter_quizzes[1][0][0]) - 1)
